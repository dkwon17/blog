...
## What's the disadvantage with vfs?
...
image::/assets/img/fuse-storage-driver/layer-diagram[]
...
All tests presented in Fig. 2. were run on an OpenShift Dedicated 4.15.3 cluster with a productized version of Eclipse Che 7.82.1. 
...
image::/assets/img/fuse-storage-driver/image-build-time[]
Fig. 3. Container image build time results

image::/assets/img/fuse-storage-driver/graphroot-size[]
